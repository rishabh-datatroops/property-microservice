error id: file://<WORKSPACE>/notification-service/app/services/NotificationService.scala:services/PropertyStateService#getPropertyState().
file://<WORKSPACE>/notification-service/app/services/NotificationService.scala
empty definition using pc, found symbol in pc: services/PropertyStateService#getPropertyState().
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -javax/inject/propertyStateService/getPropertyState.
	 -javax/inject/propertyStateService/getPropertyState#
	 -javax/inject/propertyStateService/getPropertyState().
	 -propertyStateService/getPropertyState.
	 -propertyStateService/getPropertyState#
	 -propertyStateService/getPropertyState().
	 -scala/Predef.propertyStateService.getPropertyState.
	 -scala/Predef.propertyStateService.getPropertyState#
	 -scala/Predef.propertyStateService.getPropertyState().
offset: 1114
uri: file://<WORKSPACE>/notification-service/app/services/NotificationService.scala
text:
```scala
package services
...
class NotificationService @Inject()(
  ...
  def processPropertyUpdatedEvent(event: PropertyUpdatedEvent): Future[Unit] = {
    ...
    val previousProperty = propertyStateService.getProp@@ertyState(event.propertyId)
