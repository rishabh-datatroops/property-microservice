...
# Property Microservice GraphQL API Test Script
...
# Test 1: List all properties (should be empty initially)
...
CREATE_VARIABLES='{"input": {"title": "Beautiful Downtown Apartment", "description": "A modern 2-bedroom apartment in the heart of downtown", "propertyType": "Apartment", "price": 250000.0, "location": "Downtown, City Center", "area": 1200.0, "brokerId": "broker-123"}}'
...
CREATE_VARIABLES2='{"input": {"title": "Cozy Suburban House", "description": "A charming 3-bedroom house with garden", "propertyType": "House", "price": 180000.0, "location": "Suburbia, Green Valley", "area": 2000.0, "brokerId": "broker-456"}}'
